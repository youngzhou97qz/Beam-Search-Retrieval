...
def epoch_test(ques, model_1, model_2, model_3, max_len, beam=3):  # str list
    ques = pre_process(ques, punc)
    ...
    model_3.eval()
    with torch.no_grad():
        for _ in tqdm(range(max_len//2-1)):
...
print(epoch_test(test_ques, reloading,reloading,reloading, 64))
